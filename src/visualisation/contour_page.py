...
class ContourPage(BaseVisualizationPage):
    ...
    def create_parameters(self):
        ...
        self.swap_toggle = ttk.Checkbutton(
            self.param_frame,
            style="Switch.TCheckbutton",
            text="Swap D1/D2 Axes",
        ...
        self.color_under_btn.configure(
            background=self.parameters["color_u"], relief="flat"
        )
        self.color_over_btn.configure(
            background=self.parameters["color_o"], relief="flat"
        )
