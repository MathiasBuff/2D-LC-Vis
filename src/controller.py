...
class AppController:
    ...
    def draw_figures(self) -> None:
        ...
        run_in_thread(
            ...
            (self.model.ax_D2, self.model.ax_D1, self.model.value_matrix),
            "Contour",
        )
        ...
        run_in_thread(
            draw_figure,
            self.view.raw_page,
            (self.model.data[:, 0], self.model.data[:, 1]),
            "Raw",
        )
